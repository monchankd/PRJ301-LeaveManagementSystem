        ...
        <div class="main-content">
            <div class="center-panel">
                <div class="history-card">
                    ...
                    <form method="get" action="leaveHistory" style="margin-bottom: 16px; text-align: right;">
                        ...
                        <input type="hidden" name="personalPage" value="${personalPage}" />
                        <input type="hidden" name="subordinatePage" value="${subordinatePage}" />
                    </form>
                    ...
                    <c:if test="${personalTotalPages > 1}">
                        <div class="pagination">
                            <c:if test="${personalPage > 1}">
                                <a href="leaveHistory?personalPage=1&subordinatePage=${subordinatePage}&pageSize=${pageSize}" class="page-btn">First</a>
                                <a href="leaveHistory?personalPage=${personalPage-1}&subordinatePage=${subordinatePage}&pageSize=${pageSize}" class="page-btn">Prev</a>
                            </c:if>
                            <c:forEach var="i" begin="1" end="${personalTotalPages}">
                                <a href="leaveHistory?personalPage=${i}&subordinatePage=${subordinatePage}&pageSize=${pageSize}" class="page-btn${i == personalPage ? ' active' : ''}">${i}</a>
                            </c:forEach>
                            <c:if test="${personalPage < personalTotalPages}">
                                <a href="leaveHistory?personalPage=${personalPage+1}&subordinatePage=${subordinatePage}&pageSize=${pageSize}" class="page-btn">Next</a>
                                <a href="leaveHistory?personalPage=${personalTotalPages}&subordinatePage=${subordinatePage}&pageSize=${pageSize}" class="page-btn">Last</a>
                            </c:if>
                        </div>
                    </c:if>
                    <c:if test="${not empty subordinateRequests}">
                        ...
                        <c:if test="${subordinateTotalPages > 1}">
                            <div class="pagination">
                                <c:if test="${subordinatePage > 1}">
                                    <a href="leaveHistory?personalPage=${personalPage}&subordinatePage=1&pageSize=${pageSize}" class="page-btn">First</a>
                                    <a href="leaveHistory?personalPage=${personalPage}&subordinatePage=${subordinatePage-1}&pageSize=${pageSize}" class="page-btn">Prev</a>
                                </c:if>
                                <c:forEach var="i" begin="1" end="${subordinateTotalPages}">
                                    <a href="leaveHistory?personalPage=${personalPage}&subordinatePage=${i}&pageSize=${pageSize}" class="page-btn${i == subordinatePage ? ' active' : ''}">${i}</a>
                                </c:forEach>
                                <c:if test="${subordinatePage < subordinateTotalPages}">
                                    <a href="leaveHistory?personalPage=${personalPage}&subordinatePage=${subordinatePage+1}&pageSize=${pageSize}" class="page-btn">Next</a>
                                    <a href="leaveHistory?personalPage=${personalPage}&subordinatePage=${subordinateTotalPages}&pageSize=${pageSize}" class="page-btn">Last</a>
                                </c:if>
                            </div>
                        </c:if>
                    </c:if>
