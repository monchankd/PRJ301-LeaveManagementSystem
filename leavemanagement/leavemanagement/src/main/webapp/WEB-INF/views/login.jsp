...
<head>
    ...
    <link rel="stylesheet" href="/static/css/login-anim.css">
...
<body>
    <form id="loginForm" action="login" method="post">
      ...
      <div class="inputGroup inputGroup1">
        ...
        <input type="text" id="loginUsername" name="username" maxlength="50" required />
    ...
    <script src="/static/js/login-anim.js"></script>
</body>
</html>